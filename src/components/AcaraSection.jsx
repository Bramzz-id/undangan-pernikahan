export default function AcaraSection() {
  const googleCalendarUrl =
    "https://calendar.google.com/calendar/render?action=TEMPLATE&text=Pawiwahan+Romeo+%26+Juliet&dates=20261212T010000Z/20261212T050000Z&details=Acara+Pernikahan+Adat+Bali+Romeo+and+Juliet&location=Pura/Gedung+Pernikahan";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
        <div className="bg-[#1c1410]/80 p-8 rounded-3xl shadow-xl border border-amber-600/40 hover:border-amber-500 transition-all">
          ...
          <h3 className="text-xl font-serif font-bold text-amber-300 mb-2">
            Upacara Mapejati & Pawiwahan
          </h3>
          <p className="text-xs text-amber-100/90 mb-1 font-semibold">
            Sabtu, 12 Desember 2026
          </p>
          <p className="text-xs text-amber-200/60">08.00 - 11.00 WITA</p>
        </div>
        ...
        <div className="bg-[#1c1410]/80 p-8 rounded-3xl shadow-xl border border-amber-600/40 hover:border-amber-500 transition-all">
          ...
          <h3 className="text-xl font-serif font-bold text-amber-300 mb-2">
            Resepsi / Genjek & Ramah Tamah
          </h3>
          <p className="text-xs text-amber-100/90 mb-1 font-semibold">
            Sabtu, 12 Desember 2026
          </p>
          <p className="text-xs text-amber-200/60">12.00 WITA - Selesai</p>
        </div>
      </div>
